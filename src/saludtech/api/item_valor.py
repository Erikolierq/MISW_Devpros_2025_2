...
from saludtech.modulos.item_valor.aplicacion.comandos import CrearResultadoClinicoComando
from saludtech.modulos.item_valor.aplicacion.queries import ObtenerResultadoClinicoQuery
